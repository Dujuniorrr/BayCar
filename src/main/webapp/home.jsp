...
<div class="container mt-3 ">
    ...
    <div class="row d-flex rounded">
        ...
        <div class="card mt-2 col-12 p-1 bg-red border-top-0 pt-0 border-2 border-dark mb-4" style="background-color: #444d55">
            <div class="row g-0 mt-2 bg-login">
                <div class="mt-0 p-2 m-auto bg-red row">
                    <div class="card-title d-flex m-auto col-4 fw-bold text-light" style="color: white; font-size: large;"> <%= listOlderCars.get(i).getName() %></div>
                    <div class="d-flex justify-content-start m-auto col-5" style="color: white; font-size: x-large;"><%= listOlderCars.get(i).getValue() %></div>
                    <div class="col-3">
                        <div class="d-flex justify-content-end m-auto">
