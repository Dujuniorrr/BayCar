...
<div class="container mt-3 ">
    ...
    <div class="row d-flex rounded">
        <div class="d-inline-block p-2 col-md-12 m-auto bg-red roundend-4 mt-2"> <h3 class="text-light text-center">Carros Usados Vendidos</h3></div>
        <%if(listOlderCarsSolds.isEmpty() == true){%>
        ...
        <%}else{%>
        <% for(int i = 0; i < listOlderCarsSolds.size(); i++){%>
        ...
        <div class="d-inline-block p-2 col-md-12 m-auto bg-red roundend-3 mt-2"> <h3 class="text-light text-center">Carros Usados Alugados</h3></div>
        <%if(listOlderCarsRented.isEmpty() == true){%>
        ...
        <%}else{%>
        <% for(int i = 0; i < listOlderCarsRented.size(); i++){%>
