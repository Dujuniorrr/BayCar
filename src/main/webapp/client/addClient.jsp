...
<div class="container mt-3 ">
    ...
    <form class="bg-dark" action="../addClient">
        <div class="row jumbotron box8 p-4 border-form m-0">
            <div class="col-sm-12 mx-t3 mb-4">
                <div class="col-10 col-md-6 m-auto bg-red-gradient p-1 rounded-2">
                    <h2 class="text-center text-light"> Adicionar Cliente</h2>
                </div>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
                <label for="name">Nome do Cliente</label>
                <input type="text" maxlength="30"  max="30" class="form-control" name="name" id="name" placeholder="Digite o nome do Cliente." required>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
            ...
            <div class="col-sm-6 form-group text-light mt-3">
                ...
                <input type="text" class="form-control" name="phone" id="phone" placeholder="(99) 99999-9999"  minlength="14" maxlength="14"  required>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
