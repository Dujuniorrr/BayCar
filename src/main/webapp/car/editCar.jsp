...
<div class="container mt-3 ">
    ...
    <form class="bg-dark" action="editCar">
        <div class="row jumbotron box8 p-4 border-form m-0">
            ...
            <div class="col-sm-12 mx-t3 mb-4">
                <div class="col-10 col-md-6 m-auto bg-red-gradient p-1 rounded-2">
                    <h2 class="text-center text-light"> Editar Carro</h2>
                </div>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
                <label for="name">Nome do Carro</label>
                <input type="text"  max="30" class="form-control" name="name" id="name" placeholder="Digite o nome do carro." value="<%= car.getName() %>" required>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
            ...
            <div class="col-sm-6 form-group text-light mt-3">
                ...
                <input type="textr"  min="1900" class="form-control" name="year" id="year" placeholder="Digite o ano de fabricação." value="<%= car.getYear() %>" required>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
                <label for="mark"> Marca </label>
                <input type="text"  class="form-control" name="mark" id="mark" placeholder="Digite a marca." value="<%= car.getMark() %>" required>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
            ...
            <div class="col-sm-6 form-group text-light mt-3">
                ...
                <textarea class="form-control"  name="desc" id="desc" placeholder="Digite a descrição." required style="max-height: 120px; height: 120px"><%= car.getDesc() %> </textarea>
            </div>
