...
<div class="container mt-3 ">
    ...
    <form class="bg-dark" action="../addOlderCar">
        <div class="row jumbotron box8 p-4 border-form m-0">
            ...
            <div class="col-sm-6 form-group text-light mt-3">
                ...
                <input type="text" readonly maxlength="30" class="form-control" name="name" id="name" placeholder="Digite o nome do carro." value="<%= car.getName()%>" required>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
                <label for="value">Valor do Carro</label>
                <input type="text" readonly maxlength="10" class="form-control border-form" name="value" id="value" placeholder="Digite o valor do carro." value="<%= car.getValue() %>" required>
            </div>
            <div class="col-sm-6 form-group text-light mt-3">
            ...
            <div class="col-sm-6 form-group text-light mt-3">
                <label for="mark"> testo dps </label>
